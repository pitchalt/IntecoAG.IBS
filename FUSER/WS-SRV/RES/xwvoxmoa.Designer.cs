...
namespace IntecoAG.IBS.SyncService.Messages.XVO {
    ...
    public partial class XWVOXMOA {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(XWVOXMOA));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current XWVOXMOA object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an XWVOXMOA object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output XWVOXMOA object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out XWVOXMOA obj, out System.Exception exception) {
            exception = null;
            obj = default(XWVOXMOA);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out XWVOXMOA obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static XWVOXMOA Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((XWVOXMOA)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current XWVOXMOA object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an XWVOXMOA object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output XWVOXMOA object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out XWVOXMOA obj, out System.Exception exception) {
            exception = null;
            obj = default(XWVOXMOA);
            try {
        ...
        public static bool LoadFromFile(string fileName, out XWVOXMOA obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static XWVOXMOA LoadFromFile(string fileName) {
