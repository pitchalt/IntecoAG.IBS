...
namespace IntecoAG.IBS.SyncService.Messages.XVO {
    ...
    public partial class XWVOXLOA {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(XWVOXLOA));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current XWVOXLOA object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an XWVOXLOA object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output XWVOXLOA object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out XWVOXLOA obj, out System.Exception exception) {
            exception = null;
            obj = default(XWVOXLOA);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out XWVOXLOA obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static XWVOXLOA Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((XWVOXLOA)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current XWVOXLOA object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an XWVOXLOA object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output XWVOXLOA object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out XWVOXLOA obj, out System.Exception exception) {
            exception = null;
            obj = default(XWVOXLOA);
            try {
        ...
        public static bool LoadFromFile(string fileName, out XWVOXLOA obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static XWVOXLOA LoadFromFile(string fileName) {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class XWVOXLOAVOLIST {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(XWVOXLOAVOLIST));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current XWVOXLOAVOLIST object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize() {
            System.IO.StreamReader streamReader = null;
        ...
        /// <summary>
        /// Deserializes workflow markup into an XWVOXLOAVOLIST object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output XWVOXLOAVOLIST object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out XWVOXLOAVOLIST obj, out System.Exception exception) {
            exception = null;
            obj = default(XWVOXLOAVOLIST);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out XWVOXLOAVOLIST obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static XWVOXLOAVOLIST Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((XWVOXLOAVOLIST)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
                if ((stringReader != null)) {
                    stringReader.Dispose();
        ...
        /// <summary>
        /// Serializes current XWVOXLOAVOLIST object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an XWVOXLOAVOLIST object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output XWVOXLOAVOLIST object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out XWVOXLOAVOLIST obj, out System.Exception exception) {
            exception = null;
            obj = default(XWVOXLOAVOLIST);
            try {
                obj = LoadFromFile(fileName);
        ...
        public static bool LoadFromFile(string fileName, out XWVOXLOAVOLIST obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static XWVOXLOAVOLIST LoadFromFile(string fileName) {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try {
                file = new System.IO.FileStream(fileName, FileMode.Open, FileAccess.Read);
