...
namespace IntecoAG.IBS.SyncService.Messages.XTB {
    ...
    public partial class XWTBXLIA : ServiceMessage<XWTBXLIA> {

        private string cMDField;

        private List<decimal> tBBUHCODEField;

        public XWTBXLIA() {
            this.tBBUHCODEField = new List<decimal>();
        }
